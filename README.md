...
Walkr is a voice-controlled robot that handles real-world tasks on its owner's behalf. It can understand a request, travel to where the task needs to happen, carry items, make an authorized payment, and return with the result.
...
Walkr gives the personal agent a physical presence. You tell it what you need; it works out the task and goes.
...
Walkr is not another delivery platform. It belongs to one person and acts for that person; more like a capable robotic companion than a public courier.
